...
# ======================================
# Load Models (ROOT directory paths)
# ======================================
BASE_DIR = os.path.dirname(__file__)

@st.cache_resource
def load_models():
    model_50k = pickle.load(open(os.path.join(BASE_DIR, "FIRST_AADHAR_50K_ENROLMENT.pkl"), "rb"))
    model_100k = pickle.load(open(os.path.join(BASE_DIR, "AADHAR_100K_ENROLMENT.pkl"), "rb"))
    model_150k = pickle.load(open(os.path.join(BASE_DIR, "AADHAR_150K_ENROLMENT.pkl"), "rb"))
...
# ======================================
# Load Location Data (ROOT directory)
# ======================================
location_df = pd.read_csv(os.path.join(BASE_DIR, "location_stats.csv"))
